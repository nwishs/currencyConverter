...
N = 4                                                   ##### Grid dimension  ####
zombieCoordinate = (3,1)                                ##### Zombie tuple  ####
creatureCoordinateList = [(0,1),(1,2),(1,1)]            ##### Creature coordinate tuple list ####
pattern = 'RDRU'                                        ##### Movement pattern  ####
...
class ZombieLand:
    ...
    def run(self):
        while self.zombieQueue.empty() == False:
            ...
            touchPoint = copy.copy(z.coordinate)
...
###########################    class to represent 2-d coordinates   ##########################
class Coordinate:
    def __init__(self, _x, _y, _grid):
        ...
        try:
            ...
            raise ValueError('Error validating coordinates')

    #validate the coordinates based on grid dimensions
...
###########################    class to define a type of movement   ##########################
